...
def vacancies():
    data = {"Яндекс": {
        ...
        "vacancies": [{
            ...
            'snippet': {
                'requirement': (
                    'Работали с документами. Грамотно пишете и говорите. Ответственны, внимательны и аккуратны. '
                    'Уверенно владеете ПК. Работали с Excel.'
                ),
                'responsibility': (
                    'Работа с договорами, закрывающими документами, актами, сверками. '
